...
-- Value of units, cities and tiles
UPDATE Defines
SET Value = '175'
...
INSERT INTO Defines (Name, Value)
SELECT 'WAR_DAMAGE_LEVEL_RAZING_BASE_WEIGHT', '175'; -- Set this to 0 to disable war score increase from city razing

INSERT INTO Defines (Name, Value)
SELECT 'WAR_DAMAGE_LEVEL_PILLAGED_TILE_WEIGHT', '40';

INSERT INTO Defines (Name, Value)
SELECT 'WAR_DAMAGE_LEVEL_STOLEN_TILE_WEIGHT', '80';

-- War damage level thresholds
UPDATE Defines
SET Value = '15'
