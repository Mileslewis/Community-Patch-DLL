...
public:
	...
	inline int getDIPLO_PERSONALITY_FLAVOR_MAX_VALUE()
	{
		return m_iDIPLO_PERSONALITY_FLAVOR_MAX_VALUE;
	}
	inline int getDIPLO_PERSONALITY_FLAVOR_MIN_VALUE()
	{
		return m_iDIPLO_PERSONALITY_FLAVOR_MIN_VALUE;
	}
	...
	inline int getCITY_EVENT_MIN_DURATION_BETWEEN()
	{
		return m_iCITY_EVENT_MIN_DURATION_BETWEEN;
	}
...
//Weight for City Target if Liberation Quest Active
	...
	inline float getAGGRESSIVE_ANNEX()
	{
	...
	inline int getOPINION_WEIGHT_BASE_HUMAN()
	{
		return m_iOPINION_WEIGHT_BASE_HUMAN;
	}
	inline int getOPINION_WEIGHT_BASE_AI()
	{
		return m_iOPINION_WEIGHT_BASE_AI;
	}
	...
	inline int getOPINION_WEIGHT_LAND_ANCIENT_ERA()
	{
		return m_iOPINION_WEIGHT_LAND_ANCIENT_ERA;
	}
	inline int getOPINION_WEIGHT_LAND_CLASSICAL_ERA()
	{
		return m_iOPINION_WEIGHT_LAND_CLASSICAL_ERA;
	}
	inline int getOPINION_WEIGHT_LAND_NONE_EARLY_GAME()
	{
		return m_iOPINION_WEIGHT_LAND_NONE_EARLY_GAME;
	}
	inline int getOPINION_WEIGHT_LAND_WARMONGER()
	{
		return m_iOPINION_WEIGHT_LAND_WARMONGER;
	}
	inline int getOPINION_WEIGHT_LAND_NONE_WARMONGER()
	{
		return m_iOPINION_WEIGHT_LAND_NONE_WARMONGER;
	}
	...
	inline int getOPINION_WEIGHT_VICTORY_PER_ERA()
	{
		return m_iOPINION_WEIGHT_VICTORY_PER_ERA;
	}
	inline int getOPINION_WEIGHT_VICTORY_BLOCK_FIERCE()
	{
		return m_iOPINION_WEIGHT_VICTORY_BLOCK_FIERCE;
	}
	inline int getOPINION_WEIGHT_VICTORY_BLOCK_STRONG()
	{
		return m_iOPINION_WEIGHT_VICTORY_BLOCK_STRONG;
	}
	inline int getOPINION_WEIGHT_VICTORY_BLOCK_WEAK()
	{
		return m_iOPINION_WEIGHT_VICTORY_BLOCK_WEAK;
	}
	inline int getOPINION_WEIGHT_VICTORY_BLOCK_NONE()
	{
		return m_iOPINION_WEIGHT_VICTORY_BLOCK_NONE;
	}
	inline int getOPINION_WEIGHT_VICTORY_BLOCK_PER_ERA()
	{
		return m_iOPINION_WEIGHT_VICTORY_BLOCK_PER_ERA;
	}
	inline int getOPINION_WEIGHT_VICTORY_ENDGAME_MULTIPLIER()
	{
		return m_iOPINION_WEIGHT_VICTORY_ENDGAME_MULTIPLIER;
	}
	...
	inline int getOPINION_WEIGHT_WONDER_CULTURAL()
	{
		return m_iOPINION_WEIGHT_WONDER_CULTURAL;
	}
	inline int getOPINION_WEIGHT_WONDER_NONE_CULTURAL()
	{
		return m_iOPINION_WEIGHT_WONDER_NONE_CULTURAL;
	}
	...
	inline int getOPINION_WEIGHT_MINOR_CIV_DIPLOMAT()
	{
		return m_iOPINION_WEIGHT_MINOR_CIV_DIPLOMAT;
	}
	inline int getOPINION_WEIGHT_MINOR_CIV_NONE_DIPLOMAT()
	{
		return m_iOPINION_WEIGHT_MINOR_CIV_NONE_DIPLOMAT;
	}
	inline int getOPINION_WEIGHT_TECH_FIERCE()
	{
		return m_iOPINION_WEIGHT_TECH_FIERCE;
	}
	inline int getOPINION_WEIGHT_TECH_STRONG()
	{
		return m_iOPINION_WEIGHT_TECH_STRONG;
	}
	inline int getOPINION_WEIGHT_TECH_WEAK()
	{
		return m_iOPINION_WEIGHT_TECH_WEAK;
	}
	inline int getOPINION_WEIGHT_TECH_NONE()
	{
		return m_iOPINION_WEIGHT_TECH_NONE;
	}
	...
	inline int getOPINION_WEIGHT_SAME_MAJORITY_RELIGIONS()
	{
		return m_iOPINION_WEIGHT_SAME_MAJORITY_RELIGIONS;
	}
	inline int getOPINION_WEIGHT_DIFFERENT_STATE_RELIGIONS()
	{
		return m_iOPINION_WEIGHT_DIFFERENT_STATE_RELIGIONS;
	}
	inline int getOPINION_WEIGHT_DIFFERENT_MAJORITY_RELIGIONS()
	{
		return m_iOPINION_WEIGHT_DIFFERENT_MAJORITY_RELIGIONS;
	}
	inline int getOPINION_WEIGHT_WORLD_RELIGION_MODIFIER()
	{
		return m_iOPINION_WEIGHT_WORLD_RELIGION_MODIFIER;
	}
	...
	inline int getOPINION_WEIGHT_WORLD_IDEOLOGY_MODIFIER()
	{
		return m_iOPINION_WEIGHT_WORLD_IDEOLOGY_MODIFIER;
	}
	...
	inline int getOPINION_WEIGHT_BROKEN_BULLY_CITY_STATE_PROMISE()
	{
		return m_iOPINION_WEIGHT_BROKEN_BULLY_CITY_STATE_PROMISE;
	}
	inline int getOPINION_WEIGHT_IGNORED_BULLY_CITY_STATE_PROMISE()
	{
		return m_iOPINION_WEIGHT_IGNORED_BULLY_CITY_STATE_PROMISE;
	}
	...
	inline int getOPINION_WEIGHT_SIDED_WITH_THEIR_MINOR_AGGRESSIVE_MOD()
	{
		return m_iOPINION_WEIGHT_SIDED_WITH_THEIR_MINOR_AGGRESSIVE_MOD;
	}
	...
	inline int getOPINION_WEIGHT_MUTUAL_DENOUNCEMENT()
	{
		return m_iOPINION_WEIGHT_MUTUAL_DENOUNCEMENT;
	}
	...
	inline int getRECKLESS_EXPANDER_CITIES_THRESHOLD()
	{
		return m_iRECKLESS_EXPANDER_CITIES_THRESHOLD;
	}
	inline int getRECKLESS_EXPANDER_LAND_THRESHOLD()
	{
		return m_iRECKLESS_EXPANDER_LAND_THRESHOLD;
	}
	inline int getOPINION_WEIGHT_RECKLESS_EXPANDER()
	{
		return m_iOPINION_WEIGHT_RECKLESS_EXPANDER;
	}
	inline int getOPINION_WEIGHT_RECKLESS_EXPANDER_PER_CITY()
	{
		return m_iOPINION_WEIGHT_RECKLESS_EXPANDER_PER_CITY;
	}
	inline int getOPINION_WEIGHT_RECKLESS_EXPANDER_PER_TILE()
	{
		return m_iOPINION_WEIGHT_RECKLESS_EXPANDER_PER_TILE;
	}
	inline int getOPINION_WEIGHT_RECKLESS_EXPANDER_STRATEGIC_MOD()
	{
		return m_iOPINION_WEIGHT_RECKLESS_EXPANDER_STRATEGIC_MOD;
	}
	inline int getWONDER_SPAMMER_THRESHOLD()
	{
		return m_iWONDER_SPAMMER_THRESHOLD;
	}
	inline int getOPINION_WEIGHT_WONDER_SPAMMER()
	{
		return m_iOPINION_WEIGHT_WONDER_SPAMMER;
	}
	inline int getOPINION_WEIGHT_WONDER_SPAMMER_PER_WONDER()
	{
		return m_iOPINION_WEIGHT_WONDER_SPAMMER;
	}
	inline int getOPINION_WEIGHT_WONDER_SPAMMER_CAP()
	{
		return m_iOPINION_WEIGHT_WONDER_SPAMMER_CAP;
	}
	inline int getOPINION_WEIGHT_WONDER_SPAMMER_STRATEGIC_MOD()
	{
		return m_iOPINION_WEIGHT_WONDER_SPAMMER_STRATEGIC_MOD;
	}
	inline int getOPINION_WEIGHT_TRADE_MAX()
	{
		return m_iOPINION_WEIGHT_TRADE_MAX;
	}
	inline int getOPINION_WEIGHT_STRATEGIC_TRADE_PARTNER_MULTIPLIER()
	{
		return m_iOPINION_WEIGHT_STRATEGIC_TRADE_PARTNER_MULTIPLIER;
	}
	...
	inline int getOPINION_WEIGHT_PER_CIVILIAN_KILLER_VALUE()
	{
	...
	{
		return m_iOPINION_WEIGHT_CIVILIAN_KILLER_WORLD;
	}
	inline int getOPINION_WEIGHT_PER_SIMILAR_POLICY()
	{
		return m_iOPINION_WEIGHT_PER_SIMILAR_POLICY;
	}
	inline int getOPINION_WEIGHT_PER_DIVERGENT_POLICY()
	{
		return m_iOPINION_WEIGHT_PER_DIVERGENT_POLICY;
	}
	inline int getOPINION_WEIGHT_SIMILAR_POLICIES()
	{
		return m_iOPINION_WEIGHT_SIMILAR_POLICIES;
	}
	inline int getOPINION_WEIGHT_DIVERGENT_POLICIES()
	{
		return m_iOPINION_WEIGHT_DIVERGENT_POLICIES;
	}
	inline int getPOLICY_SCORE_NEEDY_THRESHOLD()
	{
		return m_iPOLICY_SCORE_NEEDY_THRESHOLD;
	}
	inline int getPOLICY_SCORE_NEEDY_MULTIPLIER()
	{
		return m_iPOLICY_SCORE_NEEDY_MULTIPLIER;
	}
	inline int getOPINION_WEIGHT_PTP_SAME_MINOR_EACH()
	{
		return m_iOPINION_WEIGHT_PTP_SAME_MINOR_EACH;
	}
	inline int getOPINION_WEIGHT_PTP_SAME_MINOR_MIN()
	{
		return m_iOPINION_WEIGHT_PTP_SAME_MINOR_MIN;
	}
	inline int getOPINION_WEIGHT_CAPTURED_HOLY_CITY()
	{
		return m_iOPINION_WEIGHT_CAPTURED_HOLY_CITY;
	}
	inline int getOPINION_WEIGHT_CAPTURED_KEY_CITY_CAPITULATION_DIVISOR()
	{
		return m_iOPINION_WEIGHT_CAPTURED_KEY_CITY_CAPITULATION_DIVISOR;
	}
	...
	inline int getAPPROACH_NEUTRAL_HUMAN()
	{
		return m_iAPPROACH_NEUTRAL_HUMAN;
	}
	inline int getAPPROACH_FRIENDLY_HUMAN()
	{
		return m_iAPPROACH_FRIENDLY_HUMAN;
	}
	inline int getAPPROACH_AFRAID_HUMAN()
	{
		return m_iAPPROACH_AFRAID_HUMAN;
	}
	inline int getAPPROACH_GUARDED_HUMAN()
	{
		return m_iAPPROACH_GUARDED_HUMAN;
	}
	inline int getAPPROACH_DECEPTIVE_HUMAN()
	{
		return m_iAPPROACH_DECEPTIVE_HUMAN;
	}
	inline int getAPPROACH_HOSTILE_HUMAN()
	{
		return m_iAPPROACH_HOSTILE_HUMAN;
	}
	inline int getAPPROACH_WAR_HUMAN()
	{
		return m_iAPPROACH_WAR_HUMAN;
	}
	inline int getAPPROACH_NEUTRAL_HUMAN_PERCENT()
	{
		return m_iAPPROACH_NEUTRAL_HUMAN_PERCENT;
	}
	inline int getAPPROACH_FRIENDLY_HUMAN_PERCENT()
	{
		return m_iAPPROACH_FRIENDLY_HUMAN_PERCENT;
	}
	inline int getAPPROACH_AFRAID_HUMAN_PERCENT()
	{
		return m_iAPPROACH_AFRAID_HUMAN_PERCENT;
	}
	inline int getAPPROACH_GUARDED_HUMAN_PERCENT()
	{
		return m_iAPPROACH_GUARDED_HUMAN_PERCENT;
	}
	inline int getAPPROACH_DECEPTIVE_HUMAN_PERCENT()
	{
		return m_iAPPROACH_DECEPTIVE_HUMAN_PERCENT;
	}
	inline int getAPPROACH_HOSTILE_HUMAN_PERCENT()
	{
		return m_iAPPROACH_HOSTILE_HUMAN_PERCENT;
	}
	inline int getAPPROACH_WAR_HUMAN_PERCENT()
	{
		return m_iAPPROACH_WAR_HUMAN_PERCENT;
	}
	inline int getAPPROACH_NEUTRAL_AI()
	{
		return m_iAPPROACH_NEUTRAL_AI;
	}
	inline int getAPPROACH_FRIENDLY_AI()
	{
		return m_iAPPROACH_FRIENDLY_AI;
	}
	inline int getAPPROACH_AFRAID_AI()
	{
		return m_iAPPROACH_AFRAID_AI;
	}
	inline int getAPPROACH_GUARDED_AI()
	{
		return m_iAPPROACH_GUARDED_AI;
	}
	inline int getAPPROACH_DECEPTIVE_AI()
	{
		return m_iAPPROACH_DECEPTIVE_AI;
	}
	inline int getAPPROACH_HOSTILE_AI()
	{
		return m_iAPPROACH_HOSTILE_AI;
	}
	inline int getAPPROACH_WAR_AI()
	{
		return m_iAPPROACH_WAR_AI;
	}
	inline int getAPPROACH_NEUTRAL_AI_PERCENT()
	{
		return m_iAPPROACH_NEUTRAL_AI_PERCENT;
	}
	inline int getAPPROACH_FRIENDLY_AI_PERCENT()
	{
		return m_iAPPROACH_FRIENDLY_AI_PERCENT;
	}
	inline int getAPPROACH_AFRAID_AI_PERCENT()
	{
		return m_iAPPROACH_AFRAID_AI_PERCENT;
	}
	inline int getAPPROACH_GUARDED_AI_PERCENT()
	{
		return m_iAPPROACH_GUARDED_AI_PERCENT;
	}
	inline int getAPPROACH_DECEPTIVE_AI_PERCENT()
	{
		return m_iAPPROACH_DECEPTIVE_AI_PERCENT;
	}
	inline int getAPPROACH_HOSTILE_AI_PERCENT()
	{
		return m_iAPPROACH_HOSTILE_AI_PERCENT;
	}
	inline int getAPPROACH_WAR_AI_PERCENT()
	{
		return m_iAPPROACH_WAR_AI_PERCENT;
	}
	inline int getAPPROACH_MULTIPLIER_PROXIMITY_NEIGHBORS()
	{
		return m_iAPPROACH_MULTIPLIER_PROXIMITY_NEIGHBORS;
	}
	inline int getAPPROACH_MULTIPLIER_PROXIMITY_CLOSE()
	{
		return m_iAPPROACH_MULTIPLIER_PROXIMITY_CLOSE;
	}
	inline int getAPPROACH_MULTIPLIER_PROXIMITY_FAR()
	{
		return m_iAPPROACH_MULTIPLIER_PROXIMITY_FAR;
	}
	inline int getAPPROACH_MULTIPLIER_PROXIMITY_DISTANT()
	{
		return m_iAPPROACH_MULTIPLIER_PROXIMITY_DISTANT;
	}
	...
	inline int getWAR_DAMAGE_LEVEL_WORLD_WONDER_MULTIPLIER()
	{
		return m_iWAR_DAMAGE_LEVEL_WORLD_WONDER_MULTIPLIER;
	}
	inline int getWAR_DAMAGE_LEVEL_RAZING_BASE_WEIGHT()
	{
		return m_iWAR_DAMAGE_LEVEL_RAZING_BASE_WEIGHT;
	}
	inline int getWAR_DAMAGE_LEVEL_UNINVOLVED_CITY_POP_MULTIPLIER()
	{
		return m_iWAR_DAMAGE_LEVEL_UNINVOLVED_CITY_POP_MULTIPLIER;
	}
	inline int getWAR_DAMAGE_LEVEL_PILLAGED_TILE_WEIGHT()
	{
		return m_iWAR_DAMAGE_LEVEL_PILLAGED_TILE_WEIGHT;
	}
	inline int getWAR_DAMAGE_LEVEL_STOLEN_TILE_WEIGHT()
	{
		return m_iWAR_DAMAGE_LEVEL_STOLEN_TILE_WEIGHT;
	}
	...
	inline int getASSIST_VALUE_PER_TURN_DECAY()
	{
		return m_iASSIST_VALUE_PER_TURN_DECAY;
	}
	inline int getASSIST_VALUE_PER_OPINION_WEIGHT()
	{
		return m_iASSIST_VALUE_PER_OPINION_WEIGHT;
	}
	...
	inline float getUNHAPPINESS_PER_POPULATION_FLOAT()
	{
		return m_fUNHAPPINESS_PER_POPULATION_FLOAT;
	}
	...
	inline int getUNHAPPY_PRODUCTION_PENALTY()
	{
		return m_iUNHAPPY_PRODUCTION_PENALTY;
	}
	...
	inline int getUNHAPPY_THRESHOLD()
	{
		return m_iUNHAPPY_THRESHOLD;
	}
	...
	GD_INT_DEF(COMBAT_AI_OFFENSE_DAMAGEWEIGHT)
	GD_INT_DEF(COMBAT_AI_OFFENSE_DANGERWEIGHT)
	GD_INT_DEF(COMBAT_AI_OFFENSE_SCORE_BIAS)
	GD_INT_DEF(COMBAT_AI_DEFENSE_DANGERWEIGHT)
	GD_INT_DEF(COMBAT_AI_DEFENSE_SCORE_BIAS)
	GD_INT_DEF(DIPLO_AI_SHOW_OPINION_VALUES)
	GD_INT_DEF(DIPLO_AI_SHOW_TRUE_APPROACHES)
	GD_INT_DEF(DIPLO_AI_NO_VICTORY_COMPETITION)
	GD_INT_DEF(DIPLO_AI_WAR_DISALLOWED_HUMAN)
	GD_INT_DEF(DIPLO_AI_WAR_DISALLOWED_GLOBAL)
	GD_INT_DEF(DIPLO_AI_ENABLE_NUCLEAR_GANDHI)
	GD_INT_DEF(DIPLO_AI_SHOW_BASE_OPINION_WEIGHT)
	GD_INT_DEF(DIPLO_AI_HIDE_NEUTRAL_OPINION_VALUES)
	GD_INT_DEF(DIPLO_DEBUG_ENABLED)
	...
	inline int getBALANCE_CORE_MUSICIAN_BLAST_HAPPINESS()
	{
		return m_iBALANCE_CORE_MUSICIAN_BLAST_HAPPINESS;
	}
	...
	inline int getBALANCE_UNHAPPINESS_FOOD_MODIFIER()
	{
		return m_iBALANCE_UNHAPPINESS_FOOD_MODIFIER;
	}
	...
	inline int getBALANCE_HAPPINESS_LUXURY_POP_SCALER()
	{
		return m_iBALANCE_HAPPINESS_LUXURY_POP_SCALER;
	}
	inline int getBALANCE_HAPPINESS_LUXURY_COUNT_SCALER()
	{
		return m_iBALANCE_HAPPINESS_LUXURY_COUNT_SCALER;
	}
	...
	inline int getBALANCE_HAPPINESS_EMPIRE_MULTIPLIER()
	{
		return m_iBALANCE_HAPPINESS_EMPIRE_MULTIPLIER;
	}
	...
	inline int getOPINION_WEIGHT_RA()
	{
		return m_iOPINION_WEIGHT_RA;
	}
	...
	inline int getOPINION_WEIGHT_EMBASSY_MUTUAL()
	{
		return m_iOPINION_WEIGHT_EMBASSY_MUTUAL;
	}
	inline int getOPINION_WEIGHT_EMBASSY_THEM()
	{
		return m_iOPINION_WEIGHT_EMBASSY_THEM;
	}
	...
	inline int getOPINION_WEIGHT_PLUNDERED_TRADE_ROUTE()
	{
		return m_iOPINION_WEIGHT_PLUNDERED_TRADE_ROUTE;
	}
	inline int getOPINION_WEIGHT_PLOTTED_AGAINST_US()
	{
		return m_iOPINION_WEIGHT_PLOTTED_AGAINST_US;
	}
	inline int getOPINION_WEIGHT_PERFORMED_COUP()
	{
		return m_iOPINION_WEIGHT_PERFORMED_COUP;
	}
	inline int getOPINION_WEIGHT_EXCAVATED_THREE_ARTIFACTS()
	{
		return m_iOPINION_WEIGHT_EXCAVATED_THREE_ARTIFACTS;
	}
	inline int getOPINION_WEIGHT_EXCAVATED_TWO_ARTIFACTS()
	{
		return m_iOPINION_WEIGHT_EXCAVATED_TWO_ARTIFACTS;
	}
	inline int getOPINION_WEIGHT_EXCAVATED_ONE_ARTIFACT()
	{
		return m_iOPINION_WEIGHT_EXCAVATED_ONE_ARTIFACT;
	}
	inline int getOPINION_WEIGHT_MADE_NO_DIGGING_PROMISE_REDUCTION()
	{
		return m_iOPINION_WEIGHT_MADE_NO_DIGGING_PROMISE_REDUCTION;
	}
	...
	inline float getMOD_BALANCE_CORE_CORP_OFFICE_FRANCHISE_CONVERSION()
	{
		return m_fMOD_BALANCE_CORE_CORP_OFFICE_FRANCHISE_CONVERSION;
	}
	inline float getMOD_BALANCE_CORE_CORP_OFFICE_TR_CONVERSION()
	{
		return m_fMOD_BALANCE_CORE_CORP_OFFICE_TR_CONVERSION;
	}
#endif
	...
	inline int getVASSALAGE_PROTECTED_CITY_DISTANCE()
	{
		return m_iVASSALAGE_PROTECTED_CITY_DISTANCE;
	}
...
protected:
	...
	************************************************************************************************************************/
	...
	int m_iDIPLO_PERSONALITY_FLAVOR_MAX_VALUE;
	int m_iDIPLO_PERSONALITY_FLAVOR_MIN_VALUE;
	...
	int m_iCITY_EVENT_MIN_DURATION_BETWEEN;
	...
	int m_iOPINION_WEIGHT_BASE_HUMAN;
	int m_iOPINION_WEIGHT_BASE_AI;
	...
	int m_iOPINION_WEIGHT_LAND_ANCIENT_ERA;
	int m_iOPINION_WEIGHT_LAND_CLASSICAL_ERA;
	int m_iOPINION_WEIGHT_LAND_NONE_EARLY_GAME;
	int m_iOPINION_WEIGHT_LAND_WARMONGER;
	int m_iOPINION_WEIGHT_LAND_NONE_WARMONGER;
	...
	int m_iOPINION_WEIGHT_VICTORY_PER_ERA;
	int m_iOPINION_WEIGHT_VICTORY_BLOCK_FIERCE;
	int m_iOPINION_WEIGHT_VICTORY_BLOCK_STRONG;
	int m_iOPINION_WEIGHT_VICTORY_BLOCK_WEAK;
	int m_iOPINION_WEIGHT_VICTORY_BLOCK_NONE;
	int m_iOPINION_WEIGHT_VICTORY_BLOCK_PER_ERA;
	int m_iOPINION_WEIGHT_VICTORY_ENDGAME_MULTIPLIER;
	...
	int m_iOPINION_WEIGHT_WONDER_CULTURAL;
	int m_iOPINION_WEIGHT_WONDER_NONE_CULTURAL;
	...
	int m_iOPINION_WEIGHT_MINOR_CIV_DIPLOMAT;
	int m_iOPINION_WEIGHT_MINOR_CIV_NONE_DIPLOMAT;
	int m_iOPINION_WEIGHT_TECH_FIERCE;
	int m_iOPINION_WEIGHT_TECH_STRONG;
	int m_iOPINION_WEIGHT_TECH_WEAK;
	int m_iOPINION_WEIGHT_TECH_NONE;
	...
	int m_iOPINION_WEIGHT_SAME_MAJORITY_RELIGIONS;
	int m_iOPINION_WEIGHT_DIFFERENT_STATE_RELIGIONS;
	int m_iOPINION_WEIGHT_DIFFERENT_MAJORITY_RELIGIONS;
	int m_iOPINION_WEIGHT_WORLD_RELIGION_MODIFIER;
	int m_iOPINION_WEIGHT_SAME_LATE_POLICIES;
	int m_iOPINION_WEIGHT_DIFFERENT_LATE_POLICIES;
	int m_iOPINION_WEIGHT_WORLD_IDEOLOGY_MODIFIER;
	...
	int m_iOPINION_WEIGHT_BROKEN_BULLY_CITY_STATE_PROMISE;
	int m_iOPINION_WEIGHT_IGNORED_BULLY_CITY_STATE_PROMISE;
	...
	int m_iOPINION_WEIGHT_SIDED_WITH_THEIR_MINOR_AGGRESSIVE_MOD;
	...
	int m_iOPINION_WEIGHT_MUTUAL_DENOUNCEMENT;
	int m_iOPINION_WEIGHT_DENOUNCED_FRIEND;
	int m_iOPINION_WEIGHT_DENOUNCED_ENEMY;
	int m_iRECKLESS_EXPANDER_CITIES_THRESHOLD;
	int m_iRECKLESS_EXPANDER_LAND_THRESHOLD;
	int m_iOPINION_WEIGHT_RECKLESS_EXPANDER;
	int m_iOPINION_WEIGHT_RECKLESS_EXPANDER_PER_CITY;
	int m_iOPINION_WEIGHT_RECKLESS_EXPANDER_PER_TILE;
	int m_iOPINION_WEIGHT_RECKLESS_EXPANDER_STRATEGIC_MOD;
	int m_iWONDER_SPAMMER_THRESHOLD;
	int m_iOPINION_WEIGHT_WONDER_SPAMMER;
	int m_iOPINION_WEIGHT_WONDER_SPAMMER_PER_WONDER;
	int m_iOPINION_WEIGHT_WONDER_SPAMMER_CAP;
	int m_iOPINION_WEIGHT_WONDER_SPAMMER_STRATEGIC_MOD;
	int m_iOPINION_WEIGHT_TRADE_MAX;
	int m_iOPINION_WEIGHT_STRATEGIC_TRADE_PARTNER_MULTIPLIER;
	...
	int m_iOPINION_WEIGHT_SIMILAR_POLICIES;
	int m_iOPINION_WEIGHT_DIVERGENT_POLICIES;
	int m_iPOLICY_SCORE_NEEDY_THRESHOLD;
	int m_iPOLICY_SCORE_NEEDY_MULTIPLIER;
	int m_iOPINION_WEIGHT_PTP_SAME_MINOR_EACH;
	int m_iOPINION_WEIGHT_PTP_SAME_MINOR_MIN;
	int m_iOPINION_WEIGHT_CAPTURED_HOLY_CITY;
	int m_iOPINION_WEIGHT_CAPTURED_KEY_CITY_CAPITULATION_DIVISOR;
	...
	int m_iAPPROACH_NEUTRAL_HUMAN;
	int m_iAPPROACH_FRIENDLY_HUMAN;
	int m_iAPPROACH_AFRAID_HUMAN;
	int m_iAPPROACH_GUARDED_HUMAN;
	int m_iAPPROACH_DECEPTIVE_HUMAN;
	int m_iAPPROACH_HOSTILE_HUMAN;
	int m_iAPPROACH_WAR_HUMAN;
	int m_iAPPROACH_NEUTRAL_HUMAN_PERCENT;
	int m_iAPPROACH_FRIENDLY_HUMAN_PERCENT;
	int m_iAPPROACH_AFRAID_HUMAN_PERCENT;
	int m_iAPPROACH_GUARDED_HUMAN_PERCENT;
	int m_iAPPROACH_DECEPTIVE_HUMAN_PERCENT;
	int m_iAPPROACH_HOSTILE_HUMAN_PERCENT;
	int m_iAPPROACH_WAR_HUMAN_PERCENT;
	int m_iAPPROACH_NEUTRAL_AI;
	int m_iAPPROACH_FRIENDLY_AI;
	int m_iAPPROACH_AFRAID_AI;
	int m_iAPPROACH_GUARDED_AI;
	int m_iAPPROACH_DECEPTIVE_AI;
	int m_iAPPROACH_HOSTILE_AI;
	int m_iAPPROACH_WAR_AI;
	int m_iAPPROACH_NEUTRAL_AI_PERCENT;
	int m_iAPPROACH_FRIENDLY_AI_PERCENT;
	int m_iAPPROACH_AFRAID_AI_PERCENT;
	int m_iAPPROACH_GUARDED_AI_PERCENT;
	int m_iAPPROACH_DECEPTIVE_AI_PERCENT;
	int m_iAPPROACH_HOSTILE_AI_PERCENT;
	int m_iAPPROACH_WAR_AI_PERCENT;
	int m_iAPPROACH_MULTIPLIER_PROXIMITY_NEIGHBORS;
	int m_iAPPROACH_MULTIPLIER_PROXIMITY_CLOSE;
	int m_iAPPROACH_MULTIPLIER_PROXIMITY_FAR;
	int m_iAPPROACH_MULTIPLIER_PROXIMITY_DISTANT;
	...
	int m_iWAR_DAMAGE_LEVEL_WORLD_WONDER_MULTIPLIER;
	int m_iWAR_DAMAGE_LEVEL_RAZING_BASE_WEIGHT;
	int m_iWAR_DAMAGE_LEVEL_UNINVOLVED_CITY_POP_MULTIPLIER;
	int m_iWAR_DAMAGE_LEVEL_PILLAGED_TILE_WEIGHT;
	int m_iWAR_DAMAGE_LEVEL_STOLEN_TILE_WEIGHT;
	...
	int m_iASSIST_VALUE_PER_TURN_DECAY;
	int m_iASSIST_VALUE_PER_OPINION_WEIGHT;
	...
	float m_fUNHAPPINESS_PER_POPULATION_FLOAT;
	...
	GD_INT_DECL(COMBAT_AI_OFFENSE_DAMAGEWEIGHT);
	GD_INT_DECL(COMBAT_AI_OFFENSE_DANGERWEIGHT);
	GD_INT_DECL(COMBAT_AI_OFFENSE_SCORE_BIAS);
	GD_INT_DECL(COMBAT_AI_DEFENSE_DANGERWEIGHT);
	GD_INT_DECL(COMBAT_AI_DEFENSE_SCORE_BIAS);
	GD_INT_DECL(DIPLO_AI_SHOW_OPINION_VALUES);
	GD_INT_DECL(DIPLO_AI_SHOW_TRUE_APPROACHES);
	GD_INT_DECL(DIPLO_AI_NO_VICTORY_COMPETITION);
	GD_INT_DECL(DIPLO_AI_WAR_DISALLOWED_HUMAN);
	GD_INT_DECL(DIPLO_AI_WAR_DISALLOWED_GLOBAL);
	GD_INT_DECL(DIPLO_AI_ENABLE_NUCLEAR_GANDHI);
	GD_INT_DECL(DIPLO_AI_SHOW_BASE_OPINION_WEIGHT);
	GD_INT_DECL(DIPLO_AI_HIDE_NEUTRAL_OPINION_VALUES);
	GD_INT_DECL(DIPLO_DEBUG_ENABLED);
	...
	int m_iBALANCE_CORE_MUSICIAN_BLAST_HAPPINESS;
	...
	int m_iBALANCE_UNHAPPINESS_FOOD_MODIFIER;
	...
	int m_iBALANCE_HAPPINESS_EMPIRE_MULTIPLIER;
	...
	int m_iOPINION_WEIGHT_RA;
	int m_iOPINION_WEIGHT_DP;
	int m_iOPINION_WEIGHT_DP_WITH_FRIEND;
	int m_iOPINION_WEIGHT_DP_WITH_ENEMY;
	int m_iOPINION_WEIGHT_EMBASSY_MUTUAL;
	int m_iOPINION_WEIGHT_EMBASSY_THEM;
	int m_iOPINION_WEIGHT_OPEN_BORDERS_MUTUAL;
	int m_iOPINION_WEIGHT_OPEN_BORDERS_US;
	int m_iOPINION_WEIGHT_OPEN_BORDERS_THEM;
	int m_iOPINION_WEIGHT_PLUNDERED_TRADE_ROUTE;
	int m_iOPINION_WEIGHT_PLOTTED_AGAINST_US;
	int m_iOPINION_WEIGHT_PERFORMED_COUP;
	int m_iOPINION_WEIGHT_EXCAVATED_THREE_ARTIFACTS;
	int m_iOPINION_WEIGHT_EXCAVATED_TWO_ARTIFACTS;
	int m_iOPINION_WEIGHT_EXCAVATED_ONE_ARTIFACT;
	int m_iOPINION_WEIGHT_MADE_NO_DIGGING_PROMISE_REDUCTION;
	...
	float m_fMOD_BALANCE_CORE_CORP_OFFICE_FRANCHISE_CONVERSION;
	float m_fMOD_BALANCE_CORE_CORP_OFFICE_TR_CONVERSION;
#endif
	// -- floats --
	...
	int m_iVASSALAGE_PROTECTED_CITY_DISTANCE;
